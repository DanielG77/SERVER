...
// Tipado mínimo necesario (ajusta si tu Tournament ya está definido globalmente)
type Tournament = {
    id: string;
    name: string;
    createdAt: string;
...
const fetchLatestTournaments = async (): Promise<Tournament[]> => {
    ...
    console.log('LatestTournamentsSection Data:', data);
    ...
    return (
        <section className="max-w-7xl mx-auto py-16 px-4">
            <header className="mb-8 flex items-center justify-between">
                ...
                <button className="text-sm font-medium px-4 py-2 rounded-lg border border-gray-200 hover:bg-slate-50">
                    Ver todos
                </button>
            </header>
            ...
            {error && (
                <div className="text-sm text-red-500">No se pudieron cargar los torneos.</div>
            )}
